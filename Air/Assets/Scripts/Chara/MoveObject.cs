...
public abstract class MovingObject : IRotation {
    public float moveSpeed = 2; //对象移动的速度.
    public LayerMask blockingLayer; //用来确认碰撞的图层

    [SerializeField] private BoxCollider2D boxCollider; //对象的碰撞器

    [SerializeField] private Rigidbody2D rb2D; //对象的刚体
    ...
    private Vector2 beforDir = Vector2.zero;
        ...
        foreach (var dir in dirs) {
            ...
            if (cell != null) {
                ...
                if (dir != beforDir) {
                    ...
                    // TODO 这里先用笨方法，每次以原点向右方向做起始点，计算起始方向与前进方向之间的夹角
                    // Debug.Log("getRotateAngle:" + getRotateAngle(dir, right));
